  ...
  return (
    <SignInLayout>
      <div className="w-screen xl:mt-36 mt-24">
        ...
        <h1 className="w-[120px] relative ml-5 top-[150px] text-[20px] leading-[30px] md:top-[-28px] md:left-60 xl:left-0  xl:top-[3px] xl:ml-[30rem] md:text-[20px] md:font-medium pb-6 2xl:left-[3%]">
          Sneak Peak
        </h1>
        <img
