...
const STAGING_AUTH_URL =
  "https://accounts.spotify.com/authorize?client_id=6eb21b0156484d46b73a000f2113c546&response_type=code&redirect_uri=https://vercel-deployment-mtstpschp-krock07.vercel.app&scope=playlist-read-collaborative%20playlist-read-private";
                    ...
                    <Link href={el.url} key={index}>
                      <nav>
                        <li
                          className={`${
                            router.asPath === el.url
                              ? " border-b-2 whitespace-nowrap  border-[#057176] lg:px-6 2xl:px-10 md:p-0 xl:px-7 md:py-[7px] md:mb-4 md:hover:text-white md:text-white md:w-[184px] cursor-pointer xl:w-[230px] h-[52px] md:bg-[#057176] md:rounded-[10px] text-sm font-normal "
