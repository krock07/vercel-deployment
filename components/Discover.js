  ...
  return (
    <div className="bg-[#f2762f] h-[509px] w-[324px] rounded-[34px] mx-auto mt-10 md:w-[712px] md:h-[396px] md:flex md:flex-row md:items-center md:justify-between lg:w-[90%] lg:h-[635px] lg:rounded-[70px] xl:h-[835px]  ">
      <div className="ml-5 md:ml-9 xl:ml-[87px] ">
        <h1 className="text-white xl:text-left lg:text-left text-center font-bold text-[24px] xl:ml-5 mr-5 py-6 md:text-2xl lg:text-[37px] lg:ml-5">
          Discover together
        </h1>
        <p className="text-white lg:text-left xl:text-left text-center mx-6 text-sm md:text-base md:max-w-[320px] lg:text-[20px] lg:leading-normal lg:max-w-[380px] lg:font-light xl:text-[24px] xl:font-normal xl:max-w-[450px]  ">
