  ...
  return (
    <div className="bg-[#eca413] h-[509px] w-[324px] rounded-[34px] mx-auto my-10 md:w-[712px] md:h-[396px] md:flex md:flex-row-reverse md:items-center lg:w-[90%] lg:h-[635px] lg:rounded-[70px] xl:h-[835px] ">
      <div className="ml-5 md:mr-2 lg:mr-[-30px] lg:max-w-[450px] xl:mr-4 lg:pr-10 2xl:mr-[9.75%] ">
        ...
        <p className="text-white text-center xl:text-left mb-1 text-sm md:text-base md:max-w-[290px] md:mr-4 break-normal max-w-[268px] lg:text-left   lg:text-[20px] lg:leading-normal lg:font-light lg:max-w-md lg:mb-3  xl:text-[24px] xl:font-normal ">
          Create a world wide community across the diaspora
        </p>

        <p className="text-white text-center xl:text-left mb-1 lg:text-left  text-sm md:text-base md:max-w-[290px] md:mr-4 break-normal max-w-[268px]  lg:text-[20px] lg:leading-normal  lg:font-light lg:max-w-sm lg:mb-3  xl:text-[24px] xl:font-normal ">
          Spotlight untold and nuanced Black narratives
        </p>
        <p className="text-white text-center xl:text-left lg:text-left  text-sm md:text-base md:max-w-[290px] md:mr-4 break-normal max-w-[268px]  lg:text-[20px] lg:leading-normal  lg:font-light lg:max-w-md  xl:text-[24px] xl:font-normal ">
          {" "}
